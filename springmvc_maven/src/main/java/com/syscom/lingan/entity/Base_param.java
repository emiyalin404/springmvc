...
public class Base_param {
    ...
    public Base_param(String TITLE, String TAG, int SEQ_NO, String CONTENT, String CONTENT_ZH_CN, String CONTENT_ZH_TW, String CONTENT_EN_US, String LANGUAGE, String NOTES, String STATUS, String CREATOR, LocalDateTime CREATE_TIME, String UPDATER, LocalDateTime UPDATE_TIME) {
        this.TITLE = TITLE;
        this.TAG = TAG;
        this.SEQ_NO = SEQ_NO;
